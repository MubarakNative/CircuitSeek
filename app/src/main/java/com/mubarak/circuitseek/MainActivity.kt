        ...
        setContent {
            CircuitSeekTheme {
                Scaffold(
                    ...
                    CircuitSeekApp(modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
...
@Composable
fun CircuitSeekApp(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Row(
            ...
            OutlinedTextField(
                value = componentAmp,
                label = { Text(text = "Component Amp") },
                placeholder = { Text(text = "A amps that the component needs") },
                keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                onValueChange = {
                    it.toFloatOrNull()?.let {
